...
public interface LineApi {
     ...
     */
    @ApiOperation(value = "LINEアカウントの登録", nickname = "createLineAccount", notes = "LINEチャンネルトークン・シークレットを登録する", response = CreateAccountResponse.class, authorizations = {
        
        @Authorization(value = "Authorization")
         }, tags={ "line", })
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "Created", response = CreateAccountResponse.class),
    ...
    default ResponseEntity<CreateAccountResponse> createLineAccount(@ApiParam(value = "", required = true) @Valid @RequestBody CreateLineAccountRequest createLineAccountRequest) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"screenName\" : \"screenName\", \"profileImageURL\" : \"profileImageURL\" }";
     ...
     *         or Internal Server Error (status code 500)
     */
    @ApiOperation(value = "LINEアカウントを削除", nickname = "deleteLineAccount", notes = "LINEアカウントを削除", authorizations = {
     ...
     *         or Internal Server Error (status code 500)
     */
    @ApiOperation(value = "LINEアカウント情報を取得", nickname = "getLineAccount", notes = "LINEアカウント情報を取得", response = GetLineAccountResponse.class, authorizations = {
