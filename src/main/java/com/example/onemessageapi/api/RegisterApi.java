...
public interface RegisterApi {
     ...
     */
    @ApiOperation(value = "ユーザー情報登録", nickname = "createMe", notes = "ユーザー情報を新規登録",
            tags = {"user",})
    @ApiResponses(value = {
    ...
    default ResponseEntity<Void> createMe(@ApiParam(value = "",
            required = true) @Valid @RequestBody CreateMeRequest createMeRequest) {
