...
public interface RegisterApi {
    ...
    /**
     * POST /register : ユーザー情報登録 ユーザー情報を新規登録
     *
     * @param createMeRequest (required)
     * @return Created (status code 201) or Bad Request (status code 400) or
     *         Unauthorized (status code 401) or Internal Server Error (status code
     *         500)
     */
    ...
    default ResponseEntity<Void> createMe(
            @ApiParam(value = "", required = true) @Valid @RequestBody CreateMeRequest createMeRequest) {
