...
public interface MeApi {
    ...
    @ApiOperation(value = "ユーザー情報取得", nickname = "getMe", notes = "ユーザー情報を習得", response = GetMeResponse.class, authorizations = {
            ...
            @Authorization(value = "jwtAuth") }, tags = { "user", })
    @ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = GetMeResponse.class),
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType : MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"displayName\" : \"displayName\", \"id\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\" }";
